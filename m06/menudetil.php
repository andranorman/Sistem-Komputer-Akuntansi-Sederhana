		...
		<div class="content-wrapper">
			...
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				<li><a href="#"><i></i> Edit Jurnal Penerimaan </a></li>
			  </ol>
			</section>
			<!-- ./ content header (Page header) -->
			...
			<section class="content container-fluid">
				...
				<div class="row">
					<!-- kolom kiri -->
					<div class="col-md-8">
					<form name="form1" method="POST" action="menudetil_update.php" class="form-horizontal">	
						<div class="box box-primary">						
							<div class="box-header  with-border">
								<b><i class="fa fa-edit"></i> Deskripsi Jurnal Penerimaan
								<a href="menu.php" class="btn btn-xs bg-navy margin-r-5 pull-right"><i class="fa fa-sign-out"></i> </a>
								</b>
							</div>
							<div class="box-body box-profile">
								<div class="form-group">
									<input type="hidden" class="form-control" name="idjurnal" value="<?php echo($idjurnal);?>" <?php if($e==1){ ?> disabled <?php } ?> >
								</div>
								<!-- Setup No.Bukti -->
								<div class="form-group">
									<label for="nobukti" class="col-md-4 control-label">No.Bukti</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="nobukti" value="<?php echo($nobukti);?>" <?php if($e==1){ ?> disabled <?php } ?> >
									</div>
								</div>
								<!-- Setup No.Buku -->
								<div class="form-group">
									<label for="nobukti" class="col-md-4 control-label">No.Buku</label>
									<div class="col-md-8">
										<input type="text" class="form-control" name="nobuku" value="<?php echo($nobuku);?>" <?php if($e==1){ ?> disabled <?php } ?> >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" name="tgljurnal" value="<?php echo($tgljurnal);?>" <?php if($e==1){ ?> disabled <?php } ?> >
									</div>
								</div>
								<!-- Setup Deskripsi  -->
								<div class="form-group">
									...
									<div class="col-md-8">
										<textarea class="form-control" name="deskripsi" <?php if($e==1){ ?> disabled <?php } ?> ><?php echo($deskripsi);?></textarea>
									</div>
								</div>
							</div>	
							<div class="box-footer">
							 <?php if($e==0){ ?> 
									<input type="submit" value="Simpan"  class="btn btn-success btn-flat btn-block" name="submit">
							 <?php } ?>
							</div>
						</div>						
					</form>
						...
						?>				
										<tr>
											...
											<?php $m06=$_SESSION['m06']; if($m06=='a') { ?>
												<a class="btn bg-red btn-xs" href="menudetil_hapus.php?idbaris=<?php echo($idbaris);?>&idjurnal=<?php echo($idjurnal);?>&e=<?php echo($e);?>">
