...
$sql1 ="SELECT idperiode, tb_nrcsaldo.kodeakun, akun, db_awal, kr_awal, db_mutasi, kr_mutasi, 
		...
		IF(normal='D', (db_awal+db_mutasi+db_penyesuaian)-(kr_awal+kr_mutasi+kr_penyesuaian), 0) AS saldo_db, 
		IF(normal='K', (kr_awal+kr_mutasi+kr_penyesuaian)-(db_awal+db_mutasi+db_penyesuaian), 0) AS saldo_kr   
		FROM tb_nrcsaldo 
